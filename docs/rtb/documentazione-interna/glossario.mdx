...
<Chip label={"v0.6"} sx={{margin: 1, backgroundColor: 'var(--ifm-color-primary)', color: '#000'}}/>



|                    Autori                    |Ultima modifica|
|----------------------------------------------|---------------|
|Antonio Benetazzo, Elena Ferro, Leonardo Baldo|   2024-05-04  |
...
I dati atmosferici sono informazioni relative alle condizioni meteorologiche e climatiche di un'area geografica specifica. Esempi non esaustivi di dati atmosferici includono temperatura, pressione, umidità, velocità del vento, precipitazioni.

### Dati urbani

I dati urbani sono informazioni relative all'ambiente urbano e alla vita cittadina. Questi dati possono includere informazioni sul traffico, lavori in corso, incidenti stradali, parcheggi, colonnine di ricarica, guasti elettrici, isole ecologiche, livelli di acqua, e molti altri.
